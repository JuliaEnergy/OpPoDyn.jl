...
end #x_q' und T_q0 gabs nicht; cosn rated power factor = Bemessungsleistungsfaktor?

# generate all MTK bus models
@named mtkbus1 = StandardBus(; machine__H=23.64) #salient pole machine; damit nicht durch 0 geteilt für X′_q Wert >0 eingesetzt (wird nicht verwendet)
