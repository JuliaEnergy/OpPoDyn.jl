...
@test ref_rms_error(sol, ref, VIndex(:GEN1, :WT₊plant_control₊Q_branch.u), "wind.PlantController.Qbranch.y") < 1e-3
@test ref_rms_error(sol, ref, VIndex(:GEN1, :WT₊plant_control₊P_branch.u), "wind.PlantController.Pbranch.y") < 1e-3
...
@test ref_rms_error(sol, ref, VIndex(:GEN1, :WT₊drive_train₊P_e.u), "wind.DriveTrain.Pe") < 1e-3

# Electrical control (reec_b)
@test ref_rms_error(sol, ref, VIndex(:GEN1, :WT₊electrical_control₊Qext_in.u), "wind.RenewableController.Qext") < 1e-3
@test ref_rms_error(sol, ref, VIndex(:GEN1, :WT₊electrical_control₊Pref_in.u), "wind.RenewableController.Pref") < 1e-3
@test ref_rms_error(sol, ref, VIndex(:GEN1, :WT₊electrical_control₊Q_gen.u), "wind.RenewableController.Qgen") < 1e-3
@test ref_rms_error(sol, ref, VIndex(:GEN1, :WT₊electrical_control₊Wg.u), "wind.RenewableController.Wg") < 1e-3
@test ref_rms_error(sol, ref, VIndex(:GEN1, :WT₊electrical_control₊P_e.u), "wind.RenewableController.Pe") < 1e-3
@test ref_rms_error(sol, ref, VIndex(:GEN1, :WT₊electrical_control₊Vt_in.u), "wind.RenewableController.Vt") < 1e-3
...
@test ref_rms_error(sol, ref, VIndex(:GEN1, :WT₊converter_interface₊Ipcmd_in.u), "wind.RenewableGenerator.Ipcmd") < 1e-3
@test ref_rms_error(sol, ref, VIndex(:GEN1, :WT₊converter_interface₊Iqcmd_in.u), "wind.RenewableGenerator.Iqcmd") < 1e-3
