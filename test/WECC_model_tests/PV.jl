...
@test ref_rms_error(sol, ref, VIndex(:GEN1, :PV₊electrical_control₊I_pmin), "pV.RenewableController.IPMIN.y") < 1e-3
@test ref_rms_error(sol, ref, VIndex(:GEN1, :PV₊electrical_control₊I_qmax), "pV.RenewableController.IQMAX.y") < 1e-3
...
@test ref_rms_error(sol, ref, VIndex(:GEN1, :PV₊pvi), "pV.RenewableGenerator.p.vi") < 1e-3
@test ref_rms_error(sol, ref, VIndex(:GEN1, :PV₊pvr), "pV.RenewableGenerator.p.vr") < 1e-3
