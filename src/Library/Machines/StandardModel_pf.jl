@mtkmodel StandardModel_pf begin
    ...
    @parameters begin
        ...
        T′_q0=0.001, [description="q-axis transient time constant, not needed for salient pole machine"]
    ...
    @variables begin
        ...
        ψ_fd(t), [description=" flux linkage"]
        ψ_1d(t), [description=" flux linkage"]
        ψ_1q(t), [description=" flux linkage"]
        ψ_2q(t), [description=" flux linkage"]
    ...
    @equations begin
        ...
        Dt(δ) ~ ω_b * (n - ω_b/(2*π)) #(115) wenn δ = ϕ
        ...
        #Alternativ: (102)
        # τ_m ~ pt/n - xmdm - dpu * n + addmt #pt Turbine Power input signal; xmdm Torque input signal; addmt additional torque parameter; dpu * n turbine shaft friction torque
